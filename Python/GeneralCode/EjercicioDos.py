...
nike = Empresa(clientes=[hector, juan])

print(nike.clientes)  # Lista de clientes

nike.mostrar_cliente(dni="GOCM1608")  # Para mostrar el cliente

nike.borrar_cliente("MLNM1101")  # Borrar cliente
